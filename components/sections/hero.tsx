...
const slides = [
  {
    ...
    subtitle: "Masjid Impian Anda",
    description: "Spesialis pembuatan kubah masjid dengan kualitas premium",
    highlightColor: "from-blue-400 to-white/80",
  },
  {
    id: 2,
    image: "/background1.webp",
    title: "Mimbar Berkualitas",
    subtitle: "Dengan Sentuhan Artistik",
    description: "Desain mimbar masjid yang elegan dan fungsional",
    highlightColor: "from-yellow-400 to-yellow-400",
  },
  {
    id: 3,
    image: "/background3.webp",
    title: "Menara Megah",
    subtitle: "Ikon Spiritual Anda",
    description: "Pembuatan menara masjid dengan struktur kokoh",
    highlightColor: "from-blue-400 to-blue-400",
  },
]
